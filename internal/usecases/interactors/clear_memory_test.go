...
func (m *mockStatsRepositoryForClear) GetTimeline(ctx context.Context, wing string, room *string, memType *valueobjects.MemoryType, since, until *string) ([]*valueobjects.TimelineItem, error) {
	return nil, nil
}
